<template>
  ...
  >
    <template #custom-left>
      <a-input v-model="queryForm.createdByString" placeholder="请输入登录用户" allow-clear @change="search">
...
const columns: TableInstanceColumns[] = [
  ...
  { title: '用户昵称', dataIndex: 'createdByString', ellipsis: true, tooltip: true },
  ...
  { title: '登录地点', dataIndex: 'ipAddress', ellipsis: true, tooltip: true },
