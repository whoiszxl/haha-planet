...
const queryForm = reactive<MenuQuery>({
  sort: ['parentId,asc', 'createdAt,desc']
})
...
const columns: TableInstanceColumns[] = [
  { title: '菜单标题', dataIndex: 'title', slotName: 'title', width: 220, fixed: !isMobile() ? 'left' : undefined },
  ...
  { title: '创建人', dataIndex: 'createdByString', ellipsis: true, tooltip: true, show: false },
  { title: '创建时间', dataIndex: 'createdAt', width: 180 },
  { title: '修改人', dataIndex: 'updatedByString', ellipsis: true, tooltip: true, show: false },
