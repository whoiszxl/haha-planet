...
const columns: TableInstanceColumns[] = [
  ...
  { title: '创建人', dataIndex: 'createdByString', width: 140, ellipsis: true, tooltip: true, show: false },
  { title: '创建时间', dataIndex: 'createdAt', width: 180 },
  { title: '修改人', dataIndex: 'updatedByString', width: 140, ellipsis: true, tooltip: true, show: false },
