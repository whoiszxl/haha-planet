...
public class PostCacheConstants {
     ...
     * 本地缓存 - 帖子详情
     */
    public static final String LOCAL_CACHE_POST_DETAIL = "post_detail";
     ...
     * 分布式缓存 - 帖子详情前缀
     */
    public static final String CACHE_POST_DETAIL_PREFIX = "cache:post:detail:";
     ...
     * 分布式锁 - 从数据库获取帖子详情前缀
     */
    public static final String LOCK_GET_POST_DETAIL_FROM_DB_PREFIX = "lock:get_post_detail_from_db:";
     ...
     * 布隆过滤器 - 帖子ID
     */
    public static final String BLOOM_POST_ID = "bloom:post:id";
}
