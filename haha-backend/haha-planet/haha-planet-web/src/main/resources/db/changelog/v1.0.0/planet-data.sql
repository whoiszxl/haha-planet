...
(1, 1, 1, 'Spring Boot 3.0 新特性详解', '本文详细介绍Spring Boot 3.0的主要新特性，包括对Java 17的支持、GraalVM原生镜像支持、以及性能优化等方面的改进...', 1, NULL, 0, 1, 1, 234, 45, 12, 8, 15, 2, '2024-01-15 14:30:00', 85, 1001),
(2, 1, 1, '微服务架构设计最佳实践', '分享在实际项目中微服务架构设计的经验和踩过的坑，包括服务拆分、数据一致性、分布式事务等关键问题的解决方案...', 1, '["https://example.com/images/microservice1.jpg", "https://example.com/images/microservice2.jpg"]', 0, 0, 1, 189, 38, 8, 5, 12, 2, '2024-01-14 16:45:00', 78, 2003),
