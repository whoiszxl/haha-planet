...
@Data
@Schema(description = "管理员详情返回实体")
@Assemble(container = FillConstants.ADMIN_ROLE_ID_LIST, key = "id", props = @Mapping(ref = "roleIds"))
public class AdminDetailResponse extends BaseResponse {
    ...
    @Schema(description = "角色名称集合", example = "开发人员")
