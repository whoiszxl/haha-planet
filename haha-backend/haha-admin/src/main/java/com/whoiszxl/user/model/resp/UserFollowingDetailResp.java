...
@Schema(description = "用户关注(我关注的人)详情信息")
public class UserFollowingDetailResp extends BaseResponse {
    ...
    @ExcelProperty(value = "关注类型(1:普通关注 2:特别关注)")
    ...
    @ExcelProperty(value = "是否互相关注(0:否 1:是)")
    ...
    @ExcelProperty(value = "是否取消关注(0:未取消 1:已取消)")
