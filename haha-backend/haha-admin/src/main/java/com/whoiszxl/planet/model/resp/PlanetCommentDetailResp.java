...
@Schema(description = "帖子评论详情信息")
public class PlanetCommentDetailResp extends BaseResponse {
    ...
    @ExcelProperty(value = "父评论ID，0表示顶级评论")
    ...
    @ExcelProperty(value = "是否匿名评论: 0-否 1-是")
