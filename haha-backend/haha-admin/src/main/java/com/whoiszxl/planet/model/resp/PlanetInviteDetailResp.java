...
@Schema(description = "星球邀请详情信息")
public class PlanetInviteDetailResp extends BaseResponse {
    ...
    @ExcelProperty(value = "邀请类型: 1-邀请码 2-链接邀请")
    ...
    @ExcelProperty(value = "邀请状态: 1-有效 2-已使用 3-已过期 4-已取消")
