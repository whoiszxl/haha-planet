package com.whoiszxl.starter.security.mask.enums;
    ...
    BANK_CARD {
        ...
        public String mask(String str, char character, int left, int right) {
            ...
            for (int i = 0; i < midLength; ++i) {
                if (i % 4 == 0) {
                    buffer.append(StringConstants.C_SPACE);
                }
                buffer.append(character);
            }
            buffer.append(StringConstants.C_SPACE).append(cleanStr, length - endLength, length);
